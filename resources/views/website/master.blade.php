...
<!-- Mirrored from themegenix.net/html/sarsa-html/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 25 Dec 2022 10:01:01 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{asset('/')}}website/assets/css/imageRevealHover.css">
                    ...
                    <div class="tgmenu__wrap">
                        <nav class="tgmenu__nav">
                            <div class="logo d-block d-lg-none">
                                <a href="index.html" class="logo-dark"><img src="{{asset('/')}}website/assets/img/logo/logo.png" alt="Logo"></a>
                                <a href="index.html" class="logo-light"><img src="{{asset('/')}}website/assets/img/logo/w_logo.png" alt="Logo"></a>
                            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4">
                    <div class="footer__logo logo">
                        <h3 class="text-white">NewsCaster</h3>
                    </div>
                </div>
...
<script src="{{asset('/')}}website/assets/js/imageRevealHover.js"></script>
...
<!-- Mirrored from themegenix.net/html/sarsa-html/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 25 Dec 2022 10:01:08 GMT -->
</html>
